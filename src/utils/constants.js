...
const editAvatarButton = document.querySelector('.profile__avatar-edit-container')
...
export {popupImage, popupImageSelf, popupImageDescription,editButton, addButton, formEdit,
     formAdd, nameInputEdit, descriptionInputEdit, cardTemplate, validationOptions, editAvatarButton, formAvatar}